...
#define STACK_INIT_FUNCTION_NAME stack_tree_node_init
#define STACK_DEINIT_FUNCTION_NAME stack_tree_node_deinit
#define STACK_PUSH_FUNCTION_NAME stack_tree_node_push
#define STACK_POP_FUNCTION_NAME stack_tree_node_pop
