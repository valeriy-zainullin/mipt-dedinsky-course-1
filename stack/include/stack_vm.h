...
#define STACK_ITEM_TYPE uint32_t
#define STACK_TYPE_NAME Stack4b
#define STACK_ACCEPTS_ITEMS_BY_POINTERS 0

static const int STACK_4B_VERIFICATION_FAILED_EXIT_CODE = 1;
#define STACK_VERIFICATION_FAILED_EXIT_CODE STACK_4B_VERIFICATION_FAILED_EXIT_CODE
static const STACK_ITEM_TYPE STACK_INT_POISON = 0x1F2F3F4F;
...
#define STACK_INIT_FUNCTION_NAME stack_4b_init
#define STACK_DEINIT_FUNCTION_NAME stack_4b_deinit
#define STACK_PUSH_FUNCTION_NAME stack_4b_push
#define STACK_POP_FUNCTION_NAME stack_4b_pop
#define STACK_DUMP_FUNCTION_NAME stack_4b_dump
// ------

// Function definitions.
bool STACK_INIT_FUNCTION_NAME(Variable definition, STACK_TYPE_NAME* stack_ptr, void* address, size_t capacity);
...
void* stack_4b_get_content_address(STACK_TYPE_NAME* stack_ptr);
...
#define stack_4b_init(STACK_PTR, ADDRESS, SIZE) stack_4b_init(MAKE_VARIABLE_LOCATION(STACK_PTR), STACK_PTR, ADDRESS, SIZE)
#define stack_4b_deinit(STACK_PTR) stack_4b_deinit(MAKE_VARIABLE_LOCATION(STACK_PTR), STACK_PTR)
#define stack_4b_push(STACK_PTR, ITEM) stack_4b_push(MAKE_VARIABLE_LOCATION(STACK_PTR), STACK_PTR, ITEM)
#define stack_4b_pop(STACK_PTR, ITEM_PTR) stack_4b_pop(MAKE_VARIABLE_LOCATION(STACK_PTR), STACK_PTR, ITEM_PTR)
#define stack_4b_dump(STACK_PTR) stack_4b_dump(MAKE_VARIABLE_LOCATION(STACK_PTR), STACK_PTR)
#endif
