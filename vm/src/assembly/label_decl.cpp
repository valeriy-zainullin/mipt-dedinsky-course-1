...
bool vm_text_read_label_decl(VmAssemblyStatus* status, VmForwardStream* input_stream, char* label) {
	int num_chars_read = 0;
	int num_read = sscanf((char*) input_stream->bytes, VM_ASSEMBLY_LABEL_DECL_FORMAT "%n", label, &num_chars_read);
