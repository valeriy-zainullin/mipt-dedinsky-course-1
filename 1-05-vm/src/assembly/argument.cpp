...
bool vm_text_read_arg(
	...
	bool read = false;
	// TODO: custom scanf for streams returning size_t? And size_t number of bytes read?
	...
	TRY_READ_ARG(
		VM_FLOAT_IMMEDIATE_CONST_SCANF_FORMAT,
		VM_COMMAND_ARG_USES_IMMEDIATE_CONST,
		&argument->immediate_const.float_value
	) {
		argument->immediate_const.is_float = true;
	}
